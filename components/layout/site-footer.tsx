...
export function SiteFooter() {
  ...
  return (
    <footer
      id="main-footer"
      className="border-t border-brand-navy-light bg-brand-navy pb-8 pt-14 font-sans text-slate-300"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-2">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <a
                ...
                className="group inline-flex items-center gap-2 rounded-xl bg-brand-gold px-3.5 py-1.5 text-xs font-bold text-brand-navy shadow-sm transition-all hover:bg-brand-gold-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
              >
              ...
              <div className="flex items-center gap-2">
                {SOCIALS.map(({ label, Icon }) => (
                  <a
                    ...
                    href="#"
                    aria-label={label}
                    className="rounded-xl bg-white/5 p-2 text-slate-400 transition-colors hover:bg-brand-gold hover:text-brand-navy focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
                  >
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-white/5 pt-6 text-xs text-slate-500 md:flex-row">
          <p>
